...
<template>
  <el-main style="position: absolute; left: 200px; top: 61px; width: 88.43%; height: 93.84vh">
    ...
    <button class="newProjectButton" @click="toNewProjectPage()">
      <el-icon color="rgb(53,138,255)" :size="35" style="left: -40px; top: 2px"><CirclePlus/></el-icon>
      <span style="position: absolute; left: 65px; top: 14px; color: rgba(47,47,47,0.82); font-size: 16px">新建项目</span>
    </button>
  </el-main>
</template>
...
<style scoped>
  .newProjectButton {
    ...
    width: 150px;
    height: 50px;
    border: 1px solid rgb(53,138,255);
    border-radius: 30px;
  ...
  .newProjectButton:hover {
    cursor: pointer;
    box-shadow: rgba(147, 143, 143, 0.59) 1px 1px 10px 1px;
  }
