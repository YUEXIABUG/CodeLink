    ...
    <div style="position: absolute; left: 85%; width: 9.1%; height: 100%">
      ...
      <el-dropdown class="myList">
        ...
        <template #dropdown>
          <el-dropdown-menu>
            <!-- 跳转到 /user 并传递参数uid -->
            <router-link class="exitAndReset" :to="`/user?uid=${currentUser.uid}`">
              <el-dropdown-item class="el-dropdown-item-class">个人信息</el-dropdown-item>
            </router-link>
            <router-link class="exitAndReset" to="/resetPassword">
              <el-dropdown-item class="el-dropdown-item-class">修改密码</el-dropdown-item>
            </router-link>
            <router-link class="exitAndReset" to="/" @click="logout">
              <el-dropdown-item class="el-dropdown-item-class">退出登录</el-dropdown-item>
            </router-link>
          </el-dropdown-menu>
        </template>
      </el-dropdown>
